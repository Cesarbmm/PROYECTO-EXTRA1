...
public class BTreeRendererBPlus extends JFrame
{
    ...
    private final Button mAddBt, mRemoveBt;
    private final Button mAddMoreBt, mRemoveMoreBt;
    private final Button mClearBt, mSearchKeyBt;
    private final Button mListBt, mSaveBt;
    private final JTextArea mOutputConsole;


    public BTreeRendererBPlus() {
        super("B+ Renderer");
        mTreeTest = new BTreeTest();
        mBuf = new StringBuilder();
        mObjLists = new Object[TREE_HEIGHT];
        mSearchKeyBt = new Button("Buscar");
        mAddBt = new Button("Añadir");
        mRemoveBt = new Button("Eliminar");
        mAddMoreBt = new Button("Incrementar en 1");
        mRemoveMoreBt = new Button("Decrementar en 1");
        mClearBt = new Button("Limpiar");
        mListBt = new Button("Mostrar elementos");
        mSaveBt = new Button("Guardar");
